...
@interface ConfigNetworkDisconnectView ()
{
    UIView *noView;
...
@implementation ConfigNetworkDisconnectView
...
- (void)createViews{
    ...
    [self reloadDisconnectView];
}

- (void)reloadDisconnectView{
